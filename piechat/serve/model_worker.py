...
from piechat.constants import WORKER_HEART_BEAT_INTERVAL
...
from xtuner.utils import decode_base64_to_image

from piechat.utils import process_images, tokenizer_image_token
...
class ModelWorker:
    ...
    def __init__(self,
        ...
        if not no_register:
            ...
            self.heart_beat_thread = threading.Thread(target=heart_beat_worker,
                                                      args=(self, ),
                                                      daemon=True)
    ...
    def get_queue_length(self):
        if model_semaphore is None:
            ...
            return args.limit_model_concurrency - model_semaphore._value + (
                ...
                if model_semaphore._waiters is not None else 0)
    ...
    def generate_stream(self, params):
        ...
        max_context_length = getattr(model.config, 'max_position_embeddings',
                                     2048)
